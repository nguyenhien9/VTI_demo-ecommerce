...
function renderProduct() {
  ...
  productList.forEach((product) => {
    ...
    <td>
      <button type="button" class="btn btn-warning text-light" onclick ="editProduct(${idRender})">
        Edit
      </button>
    </td>
    <td>
      <button type="button" class="btn btn-danger text-white" onclick="deleteProduct(${idRender})">
        Delete
      </button>
    </td>
  </tr> 
