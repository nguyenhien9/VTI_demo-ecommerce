...
function renderProduct() {
  ...
  for (let index = 0; index < productList.length; index++) {
    document.querySelector("#tableBody").innerHTML += `
    <tr>
    <td scope="row">${product[index].id}</td>
    <td>${product[index].name}</td>
    <td>${product[index].price}<sup>đ</sup></td>
    <td>${product[index].info}</td>
    <td>${product[index].detail}</td>
    <td>${product[index].star}</td>
    <td>${product[index].image}</td>
    <td>${product[index].manufacturer}</td>
    <td>${product[index].category}</td>
    <td>
