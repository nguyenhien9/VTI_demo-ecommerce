...
function editProduct(id) {
  ...
  document.querySelector("#updateId").value = productList[id].id;
  document.querySelector("#updateName").value = productList[id].name;
  document.querySelector("#updatePrice").value = productList[id].price;
  document.querySelector("#updateInfo").value = productList[id].info;
  document.querySelector("#updateDetail").value = productList[id].detail;
  document.querySelector("#updateStar").value = productList[id].star;
  document.querySelector("#updateManufacturer").value =
    productList[id].manufacturer;
  document.querySelector("#updateCategory").value = productList[id].category;
}
...
function updateProduct() {
  productList.forEach((obj, index) => {
    ...
    let updateManufacturer = document.querySelector(
      "#updateManufacturer"
    ).value;
    let updateCategory = document.querySelector("#updateCategory").value;
  });
  productList.forEach((obj) => {
    obj[id].name = updateName;
    obj[id].price = updatePrice;
    obj[id].info = updateInfo;
    obj[id].detail = updateDetail;
    obj[id].star = updateStar;
    obj[id].manufacturer = updateManufacturer;
    obj[id].category = updateCategory;
    // localStorage.setItem("Product", JSON.stringify(productList));
    console.log(productList);
  });
  // productList[id].name = updateName;
  // productList[id].price = updatePrice;
  // productList[id].info = updateInfo;
  // productList[id].detail = updateDetail;
  // productList[id].star = updateStar;
  // productList[id].manufacturer = updateManufacturer;
  // productList[id].category = updateCategory;
  // localStorage.setItem("Product", JSON.stringify(productList));
  // console.log(productList);
}
