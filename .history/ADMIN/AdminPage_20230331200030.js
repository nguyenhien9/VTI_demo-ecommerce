...
function editProduct(id) {
  ...
  productList.forEach((product) => {
    ...
    document.querySelector("#updateInfo").value = product.name;
    document.querySelector("#updateDetail").value = product.name;
    document.querySelector("#updateStar").value = product.name;
