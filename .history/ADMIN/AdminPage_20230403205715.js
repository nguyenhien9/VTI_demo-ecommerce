...
function resetUpdate() {
  document.querySelector("#updateName").="";

  document.querySelector("#updatePrice").="";
  document.querySelector("#updateInfo").="";

  document.querySelector("#updateDetail").="";
  document.querySelector("#updateStar").="";

  document.querySelector("#updateManufacturer").="";
  document.querySelector("#updateCategory").="";
}
