...
function updateProduct() {
  let index = productList.findIndex(function (product) {
    return product.id;
  });
  ...
  localStorage.setItem("Product", JSON.parse(productList));
  console.log(localStorage.setItem("Product", JSON.parse(productList));
}
