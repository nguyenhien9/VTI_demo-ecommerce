...
function editProduct(id) {
  ...
  document.querySelector("#updateInfo").value = product.info;
  document.querySelector("#updateDetail").value = product.detail;
  document.querySelector("#updateStar").value = product.star;
  document.querySelector("#updateManufacturer").value = product.manufacturer;
