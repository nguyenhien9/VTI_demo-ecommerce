...
function renderProductList() {
  ...
  for (let index = 0; index < productList.length; index++) {
    ...
    <tr>
      ...
      <td><button class="btn btn-warning text-light" type="submit">Edit</button></td>
...
function getImageName() {
  let imgPath = document.querySelector("#image").value;
  return imgPath.split("\\");
}
console.log(getImageName(document.querySelector("#image").value));
